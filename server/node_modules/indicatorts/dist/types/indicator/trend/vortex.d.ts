 ...
 */
export declare const VortexDefaultConfig: Required<VortexConfig>;
/**
 ...
 */
export declare function vortex(highs: number[], lows: number[], closings: number[], config?: VortexConfig): VortexResult;
