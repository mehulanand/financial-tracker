 ...
 */
export declare const PSARDefaultConfig: Required<PSARConfig>;
/**
 ...
 * @return psar result.
 */
export declare function psar(highs: number[], lows: number[], closings: number[], config?: PSARConfig): PSARResult;
